...
​        超过80000的部分，交税45%
     ...
     if (before > 0 && before <= 3000){
        ...
        shui = 3000 * 0.03 + 9000 * 0.1 + 13000 *0.2 + 20000 * 0.25 + (before - 35000) * 0.30;
    }else if (before > 55000 && before <=80000) {
         shui = 3000 * 0.03 + 9000 * 0.1 + 13000 *0.2 + 20000 * 0.25 +  (before - 55000) * 0.35;
     }else if (before >= 80000) {
         shui = 3000 * 0.03 + 9000 * 0.1 + 13000 *0.2 + 20000 * 0.25 + 25000 + 0.30 +  (before - 80000) * 0.45;
     }
        //5.计算税后工资
