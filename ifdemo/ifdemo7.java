...
​       不同打折规则不累加计算。
        ...
        System.out.println("请您输入会员级别（0表示普通顾客，1表示会员）:");
        ...
        if (member == 0){
            if (money > 0 && money < 100){
                ...
                System.out.println("您应付" + money * 0.9 + "元");
            }else{
                System.out.println("您输入格式错误!");
            }
        }else if (member == 1){
            if (money > 0 && money <200){
                System.out.println("您应付" + money * 0.8 + "元");
            }else if(money >= 200){
                System.out.println("您应付" + money * 0.75 + "元");
            }else{
                System.out.println("您输入的金额有误!");
            }
        }else{
            System.out.println("您输入的类型有误哇!");
        }
    }
}
